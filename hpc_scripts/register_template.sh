...
python $SCRIPTS_DIR/register_to_template_BIDS.py  --in_dir $BASE_DIR/ --in_name space_baseline/ --img_suffix .nii.gz --out_name space_ffd25 --transform BSplineSyN* 1 --c_point 2.5 --template_file $TEMPLATE --out_warp_intfix ffd25 --output_warped_image --number_jobs $N_THREADS
