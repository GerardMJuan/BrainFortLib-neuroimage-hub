...
python /homedtic/gmarti/CODE/upf-nii/scripts/process_images.py  --in_dir /homedtic/gmarti/DATA/Data/ADNI_STANDARD/ --in_metadata /homedtic/gmarti/DATA/ADNIMRIStandard1.5/StandardFull.csv --img_suffix .nii --denoising --out_dir /homedtic/gmarti/DATA/Data/ADNI_SD_preprocessed/ --num_threads 50
