...
parser.add_argument("--in_dir", type=str, nargs=1, required=True, help='common directory input images')
    ...
    if subject[0:8] == "sub-ADNI" and subject[8:17]!="": #Subject name checking
        ...
        for session in os.listdir('./' + subject): #Listing of session files
            ...
            if session[0:5]=="ses-M" and session[5:7]!="":
                ...
                for pet in os.listdir('./' + subject + "/" + session + "/" + "pet"):
                        
                    
                    img_list = [f for f in os.listdir('./' + subject + "/" + session + "/" + "pet") if fnmatch(f, '*' + args.img_suffix[0])]
                    ...
                    for img_file in img_list:
                        ...
                        img_path = (args.in_dir[0] + "/" + subject + "/" + session + "/" + "pet" + "/" + img_file)
